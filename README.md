...
Currently at **Stage 2**: the kernel boots, prints over serial and to the VGA text
buffer, and handles its first CPU exception (a breakpoint) via the IDT. See
...
│   └── interrupts.rs      # IDT + CPU exception handlers
